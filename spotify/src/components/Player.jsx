    ...
    <div className=' h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className=' flex flex-col items-center gap-1 m-auto'>
        ...
        <div className=' flex items-center gap-5'>
          ...
          <div onClick={seekSong} ref={seekBg} className=' w-[60vw] max-w-[500px] bg-gray-200 rounded-full cursor-pointer'>
            <hr ref={seekBar} className=' h-1 border-none w-full bg-green-700 rounded-full' />
          </div>
      ...
      <div className=' hidden lg:flex items-center gap-2 opacity-75'>
        ...
        <img className='w-4 cursor-pointer' src={assets.speaker_icon} alt="" />
          <div className='w-20 bg-slate-100 h-1 rounded cursor-pointer'></div>
